...
namespace CrowdFundCore.Data
{
    public class CFDBContext:DbContext
    {
        ...
        "Server=tcp:danaikp.database.windows.net,1433;Initial Catalog=CrowdFunding5;Persist Security Info=False;User ID=dkape;Password=Zmt89950;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
